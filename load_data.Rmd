---
title: "Carregamento dos dados SIM-DOFET e SINASC (2018 - 2023) | Script não considera geocoding (lat/longi)"
author: ""
...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, include = FALSE, results='hide',quiet=TRUE,warning = FALSE, fig.width = 8, fig.height = 5, dpi = 300)
set.seed(123)
options(scipen = 999)
...
#-------------- "Entrada de variáveis no dataset SIM-DOFET:"
...
```{r, eval = TRUE, echo=TRUE, message = FALSE, warning = FALSE}
#-------------- "Saída de variáveis no dataset SIM-DOFET:"
...
```{r, eval = TRUE, echo=TRUE, message = FALSE, warning = FALSE}
#-------------- "Entrada de variáveis no dataset SINASC:"
...
```{r, eval = TRUE, echo=TRUE, message = FALSE, warning = FALSE}
#-------------- "Saída de variáveis no dataset SINASC:"
