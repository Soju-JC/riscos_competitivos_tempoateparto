...
\setlength{\cftmyequationindent}{0pt}
\setlength{\cftmyequationnumwidth}{3.2em}
...
% Permite que URLs longas sejam quebradas adequadamente nas referências.
\usepackage{xurl}
\urlstyle{same}
...
% Mantém a numeração da lista de referências em preto; a cor azul fica
% restrita às citações sobrescritas no texto.
\DeclareFieldFormat{labelnumber}{#1}

% Acabamento tipográfico da lista de referências mantendo a estrutura Vancouver:
% artigos preservam o título em fonte normal, enquanto o periódico é destacado.
